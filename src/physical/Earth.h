 ...
 * @return Distance between two points on the earth's surface in meters
 */
static auto distance(const Gahm::Types::Point &p0,
                     const Gahm::Types::Point &p1) -> double {
 ...
 * @return Azimuth between two points on the earth's surface in meters
 */
static auto azimuth(const Gahm::Types::Point &point_0,
                    const Gahm::Types::Point &point_1) -> double {
